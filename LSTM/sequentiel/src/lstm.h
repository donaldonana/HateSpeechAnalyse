...
int lstm_init_model(int X, int N, int Y, lstm_rnn* lstm, int zeros, lstm_model_parameters *params);
...
void lstm_training(lstm_rnn* lstm, lstm_rnn* gradient, lstm_rnn* AVGgradient, Data* data, lstm_values_cache** cache, double* h_prev, double* c_prev);
