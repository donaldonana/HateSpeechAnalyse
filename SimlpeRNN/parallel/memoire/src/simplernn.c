...
add_matrix(AVGgradient->W_hx, AVGgradient->W_hx, secondAVGgradient->W_hx, rnn->input_size,  rnn->hidden_size);
add_matrix(AVGgradient->W_hx, AVGgradient->W_hh, secondAVGgradient->W_hh, rnn->hidden_size, rnn->hidden_size);
add_matrix(AVGgradient->W_yh, AVGgradient->W_yh, secondAVGgradient->W_yh, rnn->hidden_size, rnn->output_size);

add_vect(AVGgradient->b_h, AVGgradient->b_h, secondAVGgradient->b_h, rnn->hidden_size);
add_vect(AVGgradient->b_y, AVGgradient->b_y, secondAVGgradient->b_h, rnn->output_size);
